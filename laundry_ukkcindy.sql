...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Okt 2023 pada 08.41
...
CREATE TABLE `tb_paket` (
  ...
  `id_outlet` int(11) NOT NULL,
  `jenis` enum('kiloan','selimut','bed cover','kaos','lainya') NOT NULL,
...
--
ALTER TABLE `tb_paket`
  ADD CONSTRAINT `tb_paket_ibfk_1` FOREIGN KEY (`id_outlet`) REFERENCES `tb_user` (`id_outlet`);
...
ALTER TABLE `tb_transaksi`
  ...
  ADD CONSTRAINT `tb_transaksi_ibfk_3` FOREIGN KEY (`id_paket`) REFERENCES `tb_paket` (`id_paket`),
